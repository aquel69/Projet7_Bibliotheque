...
public interface DaoLivre extends JpaRepository<Livre, Integer> {
    ...
    @Query(value = "SELECT  l.id_livre, COUNT(l.id_livre) as nbDePret FROM pret as pre\n" +
            "INNER JOIN ouvrage o on pre.id_ouvrage = o.id_ouvrage\n" +
            "INNER JOIN livre l on l.id_livre = o.id_livre\n" +
            "GROUP BY l.id_livre, o.nombre_exemplaires ORDER BY o.nombre_exemplaires DESC;", nativeQuery = true)
